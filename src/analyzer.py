...
class Analyzer:
    def __init__(self, tokenizer: Tokenizer, sanitizer: Sanitizer, metadata_index: MetadataIndex, config: Dict[str, Any]):
        ...
        self.stop_tokens = set(sanitizer.normalize(t) for t in raw_stop)
        
        self.global_items: List[str] = []

    def analyze(self, items: List[Any]):
        """
        Analyze a list of items (ItemInfo objects).
        """
        self.global_items = []
